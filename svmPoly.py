...
#Training Non-Linear SVM classifier using Polynomial Kernel
for Ci in Cs:
    for degreei in degrees:
        ...
        for i in range(n_epochs):
            ...
            svmPoly=SVC(C=Ci,kernel='poly',random_state=0,degree=degreei)
...
#Running SVM using polynimial kernel and C and D found corresponding to maximum accuracy
svmPoly=SVC(C=cmax,kernel='poly',random_state=0,degree=degreesmax)
